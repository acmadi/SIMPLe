    ...
    <fieldset>
        ...
        <div class="grid_6">
            <p>
                ...
                <label>
                    <textarea name="jawaban" style="width: 450px; min-height: 100px;">
                        <?php echo set_value('jawaban') ?>
                    </textarea>
                </label>
            </p>
        </div>
        ...
        <div class="grid_5">
            <p>
                ...
                <input name="nama_narasumber" type="text" value="<?php echo set_value('nama_narasumber') ?>"/></span>
            </p>

            <p>
                <label style="display: inline-block; width: 100px;">Jabatan</label>
                <span><input name="jabatan" type="text" value="<?php echo set_value('jataban') ?>"/></span>
            </p>
