        ...
        <a title="hapus" href="man_user"  onclick="return yesOrNo()" /><img src="<?php echo base_url(); ?>images/icon_delete.png"/></a>
            ...
            <div style="display: none;" id="tab2" class="tab_konten">
                <div id="tail">
                    ...
                    <input type="button" style="width:70px; height:26px; " value="Tambah" />
                    </form>
                    </form>
                </div>
            </div>
...
<div class="table">
    ...
    <input id="simpan" type="button" value="Tambah" style="width:80px; height:26px; float:right; margin:20px 0px 0px 0px; " />
