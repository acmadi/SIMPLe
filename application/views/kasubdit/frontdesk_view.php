<div id="konten">
    ...
    <input type="submit" value="Dilanjutkan" onclick="alert('Data berhasil dieskalasi'); window.location.href='<?php echo site_url('kasubdit/frontdesk') ?>';" style="width:100px; height:25px; float:right; margin-right:10px; "/>
