<div id="konten">
    ...
    <div style="text-align: right;">
        <a href="<?php echo site_url('kasubdit/frontdesk') ?>" class="button gray-pill">Batal</a>
    </div>
    ...
    <input type="submit" value="Dilanjutkan" onclick="alert('Data berhasil diekskalasi'); window.location.href='<?php echo site_url('kasubdit/frontdesk') ?>';" style="width:100px; height:25px; float:right; margin-right:10px; "/>
