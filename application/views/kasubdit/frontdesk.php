            ...
            <div id="tail">
                <table id="tableOne" class="yui">
                    ...
                    <tr>
                        ...
                        <td class="short">
                            <?php
                            if ($value->no_tiket_frontdesk > 4) {
                                echo '<span style="color:red; font-weight: bold;">' . $value->no_tiket_frontdesk . '</span>';
                            } else {
                                echo $value->no_tiket_frontdesk;
                            }
                        ...
                        <td class="action">
                            <a class="bla button blue-pill" href="<?php echo site_url('/kasubdit/frontdesk/diterima/' . $value->no_tiket_frontdesk) ?>">Diterima</a>
                            <!--                            <a id="bla2" class="button gray-pill" href="-->
                                <?php //echo site_url('/kasubdit/frontdesk/diteruskan/' . $value->no_tiket_frontdesk) ?><!--">Diteruskan</a>-->
                            <input type="button" class="bla2 button gray-pill" link="<?php echo site_url('/kasubdit/frontdesk/diteruskan/' . $value->no_tiket_frontdesk) ?>" disabled
                                   value="Diteruskan"/>
                        </td>
                    </tr>
                        <?php endforeach ?>
