            ...
            <form action="#" method="post" name=""><br/>
                ...
                <div class="table" style="font-size:10px;">
                    <div style="border: 1px solid black; padding: 20px; width: 99%">
                        <p style="position:absolute; background-color:#FFFFFF; display:block; margin: -40px 0px 0px 5px; padding: 10px">
                            Referensi Jawaban</p><br/><br/>
                        <table id="tableOne" align="center">
                            <tr>
                                <td>
                                    <div style="border:1px solid black; padding: 20px; width: 80%; float: left">
                                        <li>Jawaban 1</li>
                            ...
                            <tr>
                                <td align="right"><input type="submit" value="Referensi Peraturan"
                                                         style="width:105px; height:26px; font-size:10px; margin-right: 300px"/>
                                </td>
                            </tr>
                        </table>
            </form>
