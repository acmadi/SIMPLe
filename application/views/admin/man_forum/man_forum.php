            ...
            <div class="table">
                <div id="head">
                    <form id="textfield-search" action="man_forum_cari">
                        <input type="text" placeholder="Type Keywords in here" style="width:180px; height:16px; font-size:10px; padding:2px 4px 2px 4px; margin-right:5px; "/>
                ...
                <div id="tail">
                    <table id="tableOne" class="yui">
                        ...
                        <tr>
                            ...
                            <td><?php echo $category->judul_forum ?></td>
                            <td>
