<div class="content">
    ...
    <div class="forumpost ts">
        ...
        <h2><a href="<?php echo site_url('/forum/view/' . $forum->id_forum) ?>"><?php echo $forum->judul_forum ?></a>
        </h2>
        ...
        <div class="attachment">
            ...
            <?php echo anchor('forum/download/' . $forum->file, $forum->file, array('target' => '_blank'))?>
        </div>
        <?php endif; ?>
...
<!--            <a href="--><?php //echo site_url('/forum/view/' . $forum->id_forum) ?><!--">Baca selengkapnya</a>-->
    ...
    <div class="forumpost">
        ...
        <div class="attachment">
            Unduh berkas terlampir:
            <?php echo img('images/file_small.png')?>
            <?php echo anchor('forum/download/' . $child->file, $child->file, array('target' => '_blank'))?>
        </div>
        <?php endif; ?>
