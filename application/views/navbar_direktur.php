...
<div id="navbar" class="clearfloat">
    <ul class="sf-menu">
        <li><?php echo anchor('direktur/dashboard', 'Dashboard', "class='$nav_dashboard'");?></li>
        <li><?php echo anchor('direktur/helpdesk', 'Helpdesk', "class='$nav_helpdesk'");?></li>
        <li><?php echo anchor('direktur/frontdesk', 'Front Desk', "class='$nav_frontdesk'");?></li>
        ...
        <li><?php echo anchor('direktur/man_forum', 'Forum', "class='$nav_forum'");?></li>
    </ul>
</div>
