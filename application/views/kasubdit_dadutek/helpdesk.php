<div class="content">
    ...
    <?php echo search('kasubdit_dadutek/helpdesk/search') ?>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="action">
                <a class="button green" href="<?php echo site_url('/kasubdit_dadutek/helpdesk/view/' . $value->no_tiket_helpdesk) ?>">Jawab</a>
            </td>
        </tr>
            <?php endforeach ?>
        </tbody>
