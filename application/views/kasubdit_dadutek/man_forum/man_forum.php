<div class="content">
    ...
    <div id="postbox" style="display:none">
        ...
        $data['referrer']     = 'kasubdit_dadutek/man_forum';
        $this->load->view('kasubdit_dadutek/man_forum/form', $data) 
        ?>
    </div>
    <hr/>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <h2><a href="<?php echo site_url('/kasubdit_dadutek/man_forum/view/' . $forum->id_forum ) ?>"><?php echo $forum->judul_forum ?></a></h2>
        ...
        <div style="text-align: right;"><a href="<?php echo site_url('/kasubdit_dadutek/man_forum/view/' . $forum->id_forum ) ?>">Selengkapnya</a></div>
