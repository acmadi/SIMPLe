<div class="content">
    ...
    <div id="postbox" style="display:none">
        ...
        $data['referrer']     = 'pengaduan/man_forum';
    ...
    <div style="margin-bottom: 20px;">
        ...
        <h2><a href="<?php echo site_url('/pengaduan/man_forum/view/' . $forum->id_forum ) ?>"><?php echo $forum->judul_forum ?></a></h2>
        ...
        <div style="text-align: right;"><a href="<?php echo site_url('/pengaduan/man_forum/view/' . $forum->id_forum ) ?>">Selengkapnya</a></div>
