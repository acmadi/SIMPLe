...
<div class="content">
    ...
    <div style="display: none;" id="tab1" class="tab_konten">
        ...
        <form action="<?php echo site_url('/pelaksana/knowledge_base/search_knowledge') ?>" id="search-form" method="post" style="text-align: right;">
            ...
            <?php foreach ($result['dir'] as $idx => $res): ?>
                ...
                <div class="bla2">
                    ...
                    <div class="category-title">
                        ...
                        <a href="<?php echo site_url('/pelaksana/knowledge_base/search_all/' . $idx . '/' . $idsearch) ?>"><?php echo $res ?></a>
                    </div>
                    ...
                    <ul style="list-style: disc outside; margin-left:20px;">
                        ...
                        <li style="padding: 4px 0;">
                            <a href="<?php echo site_url('/pelaksana/knowledge_base/one/' . $result[$idx][$n]['id_knowledge_base'])?>">
                    ...
                    <div style="text-align:right; border-top: 1px dotted #cecece; padding: 20px 0 10px; margin: 0px 0;">
                        <a href="<?php echo site_url('/pelaksana/knowledge_base/search_all/' . $idx . '/' . $idsearch) ?>"
