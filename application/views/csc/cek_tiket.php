<div id="konten">
    ...
    <input type="submit" value="Batal" style="width:70px; height:25px; float:right; margin-right:10px; "/>
    ...
    <div class="table">
        <div id="head">
            ...
            <div id="tail">
                <h4 style="font-weight:bold; color:#000; margin:10px 0 10px 20px; ">Check List Kelengkapan Dokumen
                    Revisi Anggaran</h4><br/>
