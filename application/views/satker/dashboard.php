<center>
    <div style="width:1200px; height:auto; padding-top:100px; ">
        <div style="width:200px; float:left; margin-right:20px; ">
            <h6>Konsultasi Sistem Penganggaran</h6><br/>
        ...
        <div style="width:200px; float:left; margin-right:20px; ">
            <h6>Konsultasi Aplikasi Anggaran</h6><br/>
        ...
        <div style="width:200px; float:left; margin-right:0px; ">
            <h6>Saluran Pengadaan DJA</h6><br/>
