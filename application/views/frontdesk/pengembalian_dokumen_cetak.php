...
<div>
    ...
    <h1>Tanda Terima Pengembalian Dokumen #<?php echo sprintf('%05d', $dokumen->no_tiket_frontdesk) ?></h1>
    ...
    <table style="width: 100%; margin-top: 24pt">
        ...
        <tr>
            <td>Kode Satker</td>
            <td>: <?php echo $dokumen->id_satker  ?></td>
        </tr>
        <tr>
            <td>Nama Satker</td>
            <td>: <?php echo $dokumen->nama_satker ?></td>
        </tr>
        <!---->
        <!--            <tr>-->
        <!--                <td>Nama</td>-->
