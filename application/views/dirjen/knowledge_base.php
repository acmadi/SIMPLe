...
<a title="ubah" href="knowledge_ubah" /><img src="<?php echo base_url(); ?>images/edit.png"/></a> 
        <a title="hapus" href="man_user"  onclick="return confirm('Apakah Anda yakin ingin menghapus kategori?');" /><img src="<?php echo base_url(); ?>images/icon_delete.png"/></a>
            </td>
		</tr>
		<tr>
		    <td><input type="checkbox" /></td>
...
<a title="ubah" href="knowledge_kategori_ubah" /><img src="<?php echo base_url(); ?>images/edit.png"/></a> 
        <a title="hapus" href="man_user"  onclick="return confirm('Apakah Anda yakin ingin menghapus kategori?');" /><img src="<?php echo base_url(); ?>images/icon_delete.png"/></a></td>
		</tr>
		<tr>
		    <td><input type="checkbox" /></td>
			<td>02</td>
...
<a title="ubah" href="knowledge_kategori_ubah" /><img src="<?php echo base_url(); ?>images/edit.png"/></a> 
	...
	<div id="tail">
        ...
        <a href="knowledge_base"><input type="button" style="width:70px; height:26px;" value="simpan" /></a>
        </form>
        </form>
    </div>
        </div>
	...
	<div id="tail">
        ...
        <td></td>
        <td>
        <input type="button" style="width:70px; height:26px; margin:0px 76px 0px 20px;" value="reset" /><a href="knowledge_base"><input type="button" style="width:70px; height:26px; " value="simpan" /></a></td>
        </tr>
        </table>
        </form>
    </div>
