...
class Helpdesk extends CI_Controller
{
    ...
    function search($keyword = NULL)
    {
        ...
        $data['content'] = 'direktur/helpdesk';
    ...
    function view($id)
    {
        ...
        $data['content'] = 'direktur/helpdesk_view';
    ...
    function eskalasi()
    {
        if ($this->input->post('submit') == 'Eskalasi') {
            ...
            $this->_success(site_url('direktur/helpdesk'), 'Pertanyaan berhasil dieskalasi ke Dirjen', 5);
        ...
        if ($this->input->post('submit') == 'Jawab') {
            ...
            $this->_success(site_url('direktur/helpdesk'), 'Pertanyaan telah berhasil dijawab dan telah dimasukkan ke knowledge base', 5);
        }
    }
