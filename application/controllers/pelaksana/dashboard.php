...
class Dashboard extends CI_Controller
{
    ...
    function index()
    {
        ...
        $data['helpdesk_total_cs'] = $this->mhelpdesk->count_all_tiket('open', 1);
        $data['helpdesk_total_supervisor'] = $this->mhelpdesk->count_all_tiket('open', 2);
        $data['helpdesk_total_pelaksana'] = $this->mhelpdesk->count_all_tiket('open', 3);


        $data['frontdesk_total'] = $this->mfrontdesk->count_all_tiket_frontdesk('open',3); 
